...
export default function App() {
  ...
  const TitleComponent = ({ title }) => {
    return (
      <div ref={titleRef} className="relative flex items-center justify-center w-[280px] sm:w-[320px] h-[136px] sm:h-[156px]">
        ...
        <h1 className="text-3xl sm:text-4xl font-black tracking-wide pb-10 sm:pb-12">{title}</h1>
      </div>
    )
  }
    ...
    <>
      <nav className="fixed top-0 left-0 w-full z-[999] px-6 md:px-12 py-4 flex items-center justify-between backdrop-blur-xl bg-black/40 border-b border-zinc-800/50 shadow-[0_4px_30px_rgba(0,0,0,0.5)] transition-all duration-300">
        <div className="flex items-center gap-3 cursor-pointer group">
          <p className="text-2xl md:text-3xl font-black text-white md:text-[var(--theme-color-1)] tracking-widest">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <FontAwesomeIcon icon={faGithub} className="text-xl md:text-2xl text-white md:text-[var(--text-color)] group-hover:text-white transition-colors duration-300" />
          </a>
          <a
      ...
      <div className="relative w-full h-[100vh] flex flex-col items-center justify-center overflow-hidden">
        <div className="flex items-center justify-center absolute top-0 left-0 w-full h-full">
          <img src="./assets/banner.gif" alt="banner" className="w-full h-full object-cover pointer-events-none -z-10" />
        </div>
        <div className="flex flex-col items-center justify-center z-10 px-4">
          <p className="text-6xl sm:text-7xl md:text-[8rem] font-bold m-2 text-center text">GAMTHub</p>
          <p className="text-sm sm:text-base md:text-xl text-center"><TypedText text={["這裡是 GAMTHub 的小網站", "在這裡你能發現更多", "歡迎來到 GAMTHub 3"]} typeSpeed={50} backSpeed={50} /></p>
        </div>
      </div>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="w-full flex flex-col items-center justify-center gap-16 md:gap-24 px-6 md:px-[10%] py-16 md:py-24 z-20 relative">
          <TitleComponent title="關於服務器" />

          <div className="w-full flex flex-col xl:flex-row items-center xl:items-start justify-between gap-12">
            <div className="flex flex-col w-[100%] xl:w-[45%] gap-4 text-center xl:text-left">
              ...
              <p className="text-[var(--text-color)] text-base sm:text-lg leading-relaxed font-medium pt-2">
              ...
              <div className="w-full flex items-center justify-center xl:justify-start">
                <img src="/assets/bird.gif" alt="bird" className="w-48 sm:w-64 object-cover" />
              </div>
            </div>

            <div className="w-full xl:w-[45%] overflow-hidden rounded-2xl shadow-xl">
              <img src="./assets/ex1.png" alt="banner" className="w-full h-full object-cover" />
            </div>
          </div>

          <div className="w-full flex flex-col-reverse xl:flex-row items-center justify-between gap-12">
            <div className="w-full xl:w-[45%] overflow-hidden rounded-2xl shadow-xl">
          ...
          <div className="flex flex-col gap-6 w-full max-w-5xl z-10 p-5">
            <a href={stats.URLink?.GAMTChat ?? "#"} target="_blank" rel="noopener noreferrer" className="relative group overflow-hidden flex flex-col md:flex-row items-center justify-between p-6 md:p-8 rounded-2xl bg-zinc-900 border-4 border-zinc-700 hover:border-blue-500 hover:-translate-y-2 transition-all duration-300 w-full cursor-pointer">
              <div className="flex flex-col gap-3 relative z-10 w-full md:w-4/5 text-center md:text-left">
                <h3 className="text-2xl sm:text-3xl font-black text-white group-hover:text-blue-400 transition-colors">
                  GAMTChat 聊天吧
                </h3>
              ...
              <div className="mt-6 md:mt-0 relative z-10 bg-zinc-800 p-4 md:p-5 rounded-2xl border-4 border-zinc-700 group-hover:bg-blue-500 group-hover:border-blue-400 transition-all duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-300 group-hover:text-white transition-colors w-8 h-8 md:w-10 md:h-10"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
              </div>
            ...
            <a href={stats.URLink?.Sponsor ?? "#"} target="_blank" rel="noopener noreferrer" className="relative group overflow-hidden flex flex-col md:flex-row items-center justify-between p-6 md:p-8 rounded-2xl bg-zinc-900 border-4 border-zinc-700 hover:border-pink-500 hover:-translate-y-2 transition-all duration-300 w-full cursor-pointer">
              <div className="flex flex-col gap-3 relative z-10 w-full md:w-4/5 text-center md:text-left">
                <h3 className="text-2xl sm:text-3xl font-black text-white group-hover:text-pink-400 transition-colors">
                  贊助開發
                </h3>
                <p className="text-zinc-400 text-base sm:text-lg font-medium leading-relaxed">
              ...
              <div className="mt-6 md:mt-0 relative z-10 bg-zinc-800 p-4 md:p-5 rounded-2xl border-4 border-zinc-700 group-hover:bg-pink-500 group-hover:border-pink-400 transition-all duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-300 group-hover:text-white transition-colors w-8 h-8 md:w-10 md:h-10"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path></svg>
              </div>
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between p-6 md:p-10 bg-black gap-6 text-center md:text-left">
        <div>
          <img src="/assets/pedro.gif" alt="pedro" className="w-24 md:w-32" draggable="false" />
        </div>
        <div className="flex flex-col items-center md:items-end w-full md:w-auto">
          <p className="text-3xl md:text-4xl font-bold text-white">GAMT<span className="text-[var(--theme-color-2)]">Hub</span></p>
          <span className="text-white text-sm md:text-base mt-2 md:mt-0">Copyright &copy; 2024 - {new Date().getFullYear()} By <a className="text-blue-500" href="/">GAMTHub</a>, All right reserved.</span>
          <hr className="my-3 md:my-2 w-full border-zinc-700" />
          <div className="flex">
            <span className="text-white text-sm md:text-base">總訪問人數 = <CountUp end={stats.views?.player ?? 0} duration={3} /></span>
          </div>
        </div>
      </div>
    </>
